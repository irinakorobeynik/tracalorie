class CalorieTracker{
    ...
    _displayCaloriesConsumed() {
        ...
        const consume = this._meals.reduce((total, meal) => total + meal.calories, 0);
    ...
    _displayCaloriesBurned() {
        ...
        const burn = this._workouts.reduce((total, workout) => total + workout.calories, 0);
...
class App {
    constructor() {
        ...
        this._loadeventListeneres();
        this._tracker.loadItems();
    }

    _loadeventListeneres() {
